...
if ( class_exists('Plethora_Theme')) { 
	...
	Plethora_Theme::dev_comment('Start >>> WP template file loaded: category.php ( just includes a template part file, check next comment )', 'templateparts');
	get_template_part('includes/partials/layout', 'blog' );
	Plethora_Theme::dev_comment('End <<< category.php', 'templateparts');
