...
?>
<div class="col-sm-3 col-md-3"><?php dynamic_sidebar('sidebar-footer-one'); ?></div>
<?php
Plethora_Theme::dev_comment('End <<< Footer Widget Area 1', 'layout');
Plethora_Theme::dev_comment('Start >>> Footer Widget Area 2', 'layout');
?>
<div class="col-sm-3 col-md-3"><?php dynamic_sidebar('sidebar-footer-two'); ?></div>
<?php
Plethora_Theme::dev_comment('End <<< Footer Widget Area 2', 'layout');
Plethora_Theme::dev_comment('Start >>> Footer Widget Area 3', 'layout');
?>
<div class="col-sm-3 col-md-3"><?php dynamic_sidebar('sidebar-footer-three'); ?></div>
<?php
Plethora_Theme::dev_comment('End <<< Footer Widget Area 3', 'layout');
Plethora_Theme::dev_comment('Start >>> Footer Widget Area 4', 'layout');
?>
<div class="col-sm-3 col-md-3"><?php dynamic_sidebar('sidebar-footer-four'); ?></div>
<?php
Plethora_Theme::dev_comment('End <<< Footer Widget Area 4', 'layout');
