...
File Description: Audio Post Format Display Template Part 

*/
Plethora_Theme::dev_comment('Start >>> Audio content template part loaded: '. THEME_PARTIALS_DIR . '/'. basename( __FILE__ ), 'templateparts');
$audio_html    = Plethora_Theme::html_content_audio();
...
if ( is_single() ) :
     ...
     Plethora_Theme::dev_comment('Start >>> Single Post Content ( audio post format )', 'layout'); 
     ...
     <article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
          ...
          <?php if ( $display_media == 'display' && !empty( $audio_html) ) { echo '<figure>'. $audio_html .'</figure>'; } ?>
          <?php the_content(); ?>
...
// Listing view
     ...
     Plethora_Theme::dev_comment('Start >>> Loop Item ( audio post format )', 'layout');
     ...
     <article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
          ...
          <div class="post_content">
          <?php if ( $display_media_on_list != 'hide' && !empty( $audio_html) ) { echo '<figure>'. $audio_html .'</figure>'; } ?>
               <?php 
