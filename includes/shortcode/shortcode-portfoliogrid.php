...
File Description: Portfolio Grid shortcode

*/

if ( ! defined( 'ABSPATH' ) ) exit; // NO DIRECT ACCESS 

if ( class_exists('Plethora_Shortcode') && !class_exists('Plethora_Shortcode_Portfoliogrid') && class_exists('Plethora_Posttype_Portfolio') ):

	/**
	 * @package Plethora Base
	 */

	class Plethora_Shortcode_Portfoliogrid extends Plethora_Shortcode { 
       ...
       */
       public function params() {
          ...
          $sc_settings =  array(
              "base"              => 'sc_portfoliogrid',
              "name"              => __("Portfolio Grid", 'cleanstart'),
              "description"       => __('Build a custom portfolio grid', 'cleanstart'),
              "class"             => "",
              "weight"            => 1,
              ...
              "params"            => array(
                  ...
                  array(
                      ...
                      "description"   => __("Display the Project types menu", 'cleanstart')
                  ),
                  array(
                      "param_name"    => "exclude_categories",
                      "type"          => "checkbox",
                      "heading"       => __("Exclude project types", 'cleanstart'),
                      "value"         => class_exists('Plethora_Data') ? Plethora_Data::categories(array('taxonomy'=>'project-type')) : Plethora_Helper::array_categories(array('taxonomy'=>'project-type')) ,
                      "description"   => __("Check every project type that you don't want to be included in results", 'cleanstart')
                  )
              )
          );
       ...
       */
       public function content( $atts, $content = null ) {
          ...
          $portfoliogrid_id = mt_rand( 1,5000 ); // VERY IMPORTANT! This generates a unique id for javascript inits
          ...
          if( $post_query->have_posts() ) {
            ...
            $post_query->the_post();
                ...
                $post_categories = wp_get_object_terms( get_the_ID(), 'project-type' );
          ...
          if (!empty($categories)) { 
            ...
            $section_filters .= '     <ul class="portfolio_filters" id="filt_'. $portfoliogrid_id  .'">'."\n";
...
jQuery(function() {
  ...
  var container = jQuery('#cont_${portfoliogrid_id}'); 
  var filt  = jQuery('#filt_${portfoliogrid_id}');
...
INITSCRIPT;
          ...
          if ($val_layout == 'portfolio_strict') { 
            ...
            $return .= '                    <div class="row isotope_portfolio_container" id="cont_'. $portfoliogrid_id  .'">'."\n";
