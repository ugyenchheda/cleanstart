...
File Description: WooCommerce Product Options Metabox

*/

if ( ! defined( 'ABSPATH' ) ) exit; // NO DIRECT ACCESS 

if ( class_exists('Plethora_Metabox') && class_exists('woocommerce') && !class_exists('Plethora_Metabox_Product') ): 

	/**
	 * @package Plethora Framework
	 */

	class Plethora_Metabox_Product {
    	...
    	$sections[] = array(
	        ...
	        'desc' => ' <a href="'. admin_url('admin.php?page=cleanstart_options&tab=11') . '" target="_blank">'. __('Click here', 'cleanstart') . '</a>'. __(' to change default values.<br>', 'cleanstart'),
	    ...
	    $sections[] = array(
	        ...
	        'fields'        => array(
				...
				array(
					...
					'options'  => array(
							// 'shoptitle'   => __('Shop Title / Subtitle', 'cleanstart'),
	    ...
	    $metabox = array(
	        'id'            => 'metabox-product',
	        'title'         => __( 'Product Post Options', 'cleanstart' ),
       ...
       */
       public static function get_feature_options() {
          ...
          $feature_options = array ( 
              'switchable' => true,
              'options_title' => 'Metabox // Product Post Options',
