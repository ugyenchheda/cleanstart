...
(function (factory) {
	...
	$.BigVideo = function(options) {
		...
		function initPlayControl() {
			...
			var playpause = (isPlaying)? 'pause' : 'play';
			var volumelevel = (isAmbient)? 'fa-volume-up' : 'fa-volume-off';
			var markup = ''+
				'<div id="big-video-control-container">'+
					'<div id="big-video-control">'+
						'<a href="#" id="big-video-control-play"><i class="fa fa-' + playpause + '"></i></a>'+
						'<a href="#" id="big-video-control-sound"><i class="fa ' + volumelevel + '"></i></a>'+
		...
		BigVideo.init = function() {
			if (!isInitialized) {
				...
				player = videojs(vidEl.substr(1), {
					// ORIGINAL CODE [EDITED] controls & autoplay properties
					controls:true,
					autoplay:settings.forceAutoplay,
					preload:'auto',
		...
		BigVideo.show = function(source,options) {
			...
			// ORIGINAL CODE [EDITED] Causing loop to run everytime ambient was set to true. Not something we want really.
			// if (isAmbient || options.doLoop) settings.doLoop = true;
			if ( options.doLoop ) settings.doLoop = true;
